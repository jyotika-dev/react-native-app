        ...
        <Link href={`/movies/${id}`} asChild>
            <TouchableOpacity className='w-[30%]'>
                ...
                <View className='flex-row items-center justify-between'>
                    <Text className='text-xs font-medium text-light-300 mt-1'>{release_date?.split('-')[0]}</Text>
                    {/* <Text className='text-xs font-medium text-light-300 mt-1 uppercase'>Movie</Text> */}
